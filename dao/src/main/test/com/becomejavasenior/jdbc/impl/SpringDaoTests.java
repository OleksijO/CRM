...
import static com.becomejavasenior.jdbc.impl.SpringDaoTests.APPLICATION_CONTEXT_FILE;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(APPLICATION_CONTEXT_FILE)
abstract public class SpringDaoTests {
    public static final String APPLICATION_CONTEXT_FILE = "classpath:dao_test_plain_jdbc.xml";
    @Autowired
