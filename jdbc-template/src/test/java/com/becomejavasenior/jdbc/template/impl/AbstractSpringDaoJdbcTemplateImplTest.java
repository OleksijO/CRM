...
import static com.becomejavasenior.jdbc.template.impl.AbstractSpringDaoJdbcTemplateImplTest.APPLICATION_CONTEXT_FILE;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(APPLICATION_CONTEXT_FILE)

abstract public class AbstractSpringDaoJdbcTemplateImplTest {
